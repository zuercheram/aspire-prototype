...
\documentclass[listof=totoc, bibliography=totoc, a4paper, 11pt, numbers=noenddot]{scrartcl}
...
\usepackage{graphicx}
\graphicspath{{./Ressources/Bilder/}}
\usepackage{caption}
...
\begin{document}
    ...
    \newgeometry{left=30mm, right=20mm, top=30mm, bottom=30mm}
