...
\loadglsentries[acronym]{Verzeichnisse/abkuerzungen}
\loadglsentries{Verzeichnisse/glossar}
...
\begin{document}
    ...
    \begin{spacing}{1.5} % Zeilenabstand: 1,5 fuer den Textteil
        ...
        \include{Text/03_einleitung}

        % Recherche
        \include{Text/04_recherche}

        % Implementierung
        \include{Text/05_implementierung}

        % ergebnis
        \include{Text/06_ergebnis}

        % Fazit
        \include{Text/07_fazit}
    \end{spacing}
    %-------------------------------------------------------------------------------------------------------------------
    ...
    % Glossar
    \printnoidxglossary[type=\acronymtype,title=Abkürzungen,nonumberlist]

    \printnoidxglossary[title=Glossar,nonumberlist]
